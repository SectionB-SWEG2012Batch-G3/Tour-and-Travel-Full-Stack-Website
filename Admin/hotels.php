    ...
    <tbody>
      <?php foreach ($hotels as $i => $hotel):?>
        ...
        <td scope="row">
          ...
          <a class="btn btn-sm btn-outline-primary" href="manageHotelImages.php?id=<?php echo $hotel['id']?>&active=hotel&name=<?php echo $hotel['hotel_name']?>"><?php echo $hotel['hotel_name']?>'s Images</a>
        </td>      
        </tr>
        <tr>
      <?php endforeach;?>

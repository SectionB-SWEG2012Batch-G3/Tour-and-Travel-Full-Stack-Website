    ...
    <tbody>
      <?php foreach ($places as $i => $place):?>
        ...
        <td scope="row" rowspan="2">
          ...
          <a href="manageDestImages.php?id=<?php echo $place['id']?>&active=destination&name=<?php echo $place['title']?>" class="btn btn-sm btn-outline-primary m-2">Manage the images</a>
        </td>      
        </tr>
        <tr>
      <?php endforeach;?>

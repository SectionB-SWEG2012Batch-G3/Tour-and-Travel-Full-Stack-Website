...
starCounter = JSON.parse(localStorage.getItem("hondaCityVote")) ? JSON.parse(localStorage.getItem("hondaCityVote")) : 0
averageStar = JSON.parse(localStorage.getItem("hondaCityRating")) ? JSON.parse(localStorage.getItem("hondaCityRating")) : 0
function countAndDisplay(starValue) {
    ...
    localStorage.setItem('hondaCityVote', JSON.stringify(starCounter));
    localStorage.setItem('hondaCityRating', JSON.stringify(averageStar));

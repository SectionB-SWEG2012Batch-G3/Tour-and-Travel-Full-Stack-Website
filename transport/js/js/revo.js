...
starCounter = JSON.parse(localStorage.getItem("revoVote")) ? JSON.parse(localStorage.getItem("revoVote")) : 0
averageStar = JSON.parse(localStorage.getItem("revoRating")) ? JSON.parse(localStorage.getItem("revoRating")) : 0
function countAndDisplay(starValue) {
    ...
    localStorage.setItem('revoVote', JSON.stringify(starCounter));
    localStorage.setItem('revoRating', JSON.stringify(averageStar));

...
starCounter = JSON.parse(localStorage.getItem("v8Vote")) ? JSON.parse(localStorage.getItem("v8Vote")) : 0
averageStar = JSON.parse(localStorage.getItem("v8Rating")) ? JSON.parse(localStorage.getItem("v8Rating")) : 0
function countAndDisplay(starValue) {
    ...
    localStorage.setItem('v8Vote', JSON.stringify(starCounter));
    localStorage.setItem('v8Rating', JSON.stringify(averageStar));

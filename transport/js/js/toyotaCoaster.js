...
starCounter = JSON.parse(localStorage.getItem("toyotaCoasterVote")) ? JSON.parse(localStorage.getItem("toyotaCoasterVote")) : 0
averageStar = JSON.parse(localStorage.getItem("toyotaCoasterRating")) ? JSON.parse(localStorage.getItem("toyotaCoasterRating")) : 0
function countAndDisplay(starValue) {
    ...
    localStorage.setItem('toyotaCoasterVote', JSON.stringify(starCounter));
    localStorage.setItem('toyotaCoasterRating', JSON.stringify(averageStar));

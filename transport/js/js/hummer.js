...
starCounter = JSON.parse(localStorage.getItem("hummerVote")) ? JSON.parse(localStorage.getItem("hummerVote")) : 0
averageStar = JSON.parse(localStorage.getItem("hummerRating")) ? JSON.parse(localStorage.getItem("hummerRating")) : 0
function countAndDisplay(starValue) {
    ...
    localStorage.setItem('hummerVote', JSON.stringify(starCounter));
    localStorage.setItem('hummerRating', JSON.stringify(averageStar));

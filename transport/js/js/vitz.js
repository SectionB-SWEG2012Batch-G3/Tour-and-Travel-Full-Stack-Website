...
starCounter = JSON.parse(localStorage.getItem("vitzVote")) ? JSON.parse(localStorage.getItem("vitzVote")) : 0
averageStar = JSON.parse(localStorage.getItem("vitzRating")) ? JSON.parse(localStorage.getItem("vitzRating")) : 0
function countAndDisplay(starValue) {
    ...
    localStorage.setItem('vitzVote', JSON.stringify(starCounter));
    localStorage.setItem('vitzRating', JSON.stringify(averageStar));

...
starCounter = JSON.parse(localStorage.getItem("hyundaiVote")) ? JSON.parse(localStorage.getItem("hyundaiVote")) : 0
averageStar = JSON.parse(localStorage.getItem("hyundaiRating")) ? JSON.parse(localStorage.getItem("hyundaiRating")) : 0
function countAndDisplay(starValue) {
    ...
    localStorage.setItem('hyundaiVote', JSON.stringify(starCounter));
    localStorage.setItem('hyundaiRating', JSON.stringify(averageStar));

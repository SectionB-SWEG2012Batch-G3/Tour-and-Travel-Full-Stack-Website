...
starCounter = JSON.parse(localStorage.getItem("toyotaHiaceVote")) ? JSON.parse(localStorage.getItem("toyotaHiaceVote")) : 0
averageStar = JSON.parse(localStorage.getItem("toyotaHiaceRating")) ? JSON.parse(localStorage.getItem("toyotaHiaceRating")) : 0
function countAndDisplay(starValue) {
    ...
    localStorage.setItem('toyotaHiaceVote', JSON.stringify(starCounter));
    localStorage.setItem('toyotaHiaceRating', JSON.stringify(averageStar));

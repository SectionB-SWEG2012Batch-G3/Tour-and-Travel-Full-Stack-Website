...
starCounter = JSON.parse(localStorage.getItem("rav4Vote")) ? JSON.parse(localStorage.getItem("rav4Vote")) : 0
averageStar = JSON.parse(localStorage.getItem("rav4Rating")) ? JSON.parse(localStorage.getItem("rav4Rating")) : 0
function countAndDisplay(starValue) {
    ...
    localStorage.setItem('rav4Vote', JSON.stringify(starCounter));
    localStorage.setItem('rav4Rating', JSON.stringify(averageStar));

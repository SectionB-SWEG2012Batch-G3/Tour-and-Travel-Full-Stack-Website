...
starCounter = JSON.parse(localStorage.getItem("yarisVote")) ? JSON.parse(localStorage.getItem("yarisVote")) : 0
averageStar = JSON.parse(localStorage.getItem("yarisRating")) ? JSON.parse(localStorage.getItem("yarisRating")) : 0
function countAndDisplay(starValue) {
    ...
    localStorage.setItem('yarisVote', JSON.stringify(starCounter));
    localStorage.setItem('yarisRating', JSON.stringify(averageStar));

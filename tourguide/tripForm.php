        ...
        <fieldset>
            ...
            <form id="form1">
                <div class="input-container">
                    ...
                    <input type="text" name="Fname" class="no-outline" id="name" placeholder="Full Name" maxlength="20"
                        required>
                ...
                <div class="input-container">
                    ...
                    <input type="Search" class="no-outline" id="place" name="place" value="Addis Ababa, Ethiopia"
                        required>
                    <i class="fas fa-check-circle"></i>
                    <i class="fas fa-exclamation-circle"></i>
                    <small></small>
                ...
                <div class="input-container">
                    ...
                    <select name="guides" id="guides">
                        ...
                        <option
                            value="<?php echo $tourguide['name']?>"
                            <?php if ($name === $tourguide['name']) {
    echo 'selected';
}?>>
                            <?php
                                echo $tourguide['name'];
                ...
                <div class="input-container">
                    ...
                    <input type="datetime-local" id="St-Date" name="Date-st" required>
                ...
                <div class="input-container">
                    ...
                    <input type="datetime-local" id="En-Date" name="Date-en" required>
                    <i style="position: absolute;right: 80px;top:38px" class="fas fa-check-circle"></i>
                    <i style="position: absolute;right: 80px;top:38px" class="fas fa-exclamation-circle"></i>
                    <small></small>
                </div>
                ...
                <div class="input-container">
                    ...
                    <input type="text" id="perhour" name="perHour" disabled>
                    <i class="fas fa-check-circle"></i>
                    <i class="fas fa-exclamation-circle"></i>
                    <small></small>
                </div>
